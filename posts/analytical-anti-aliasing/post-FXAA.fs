...
void main() {
	gl_FragColor = FxaaPixelShader(texCoord, vec4(0.0), u_texture, u_texture, u_texture, RcpFrame, vec4(0.0), vec4(0.0), vec4(0.0), 0.75, 0.166, 0.0833, 8.0, 0.125, 0.05,  vec4(0.0));
}