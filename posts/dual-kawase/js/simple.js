...
export async function setupSimple() {
	/* Init */
	const container = document.getElementById('WebGL-Box-BoxBlur');
	...
	const ctx = {
		...
		mode: "scene",
		flags: { isRendering: false, buffersInitialized: false, initComplete: false},
		/* Textures */
	...
	const ui = {
		...
		radios: document.querySelectorAll('input[name="modeSimple"]'),
	};
