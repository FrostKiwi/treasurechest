...
self.addEventListener("message", async (ev) => {
	...
	const ctx = {
		...
		shd: {
			blur: {
				handle: null, uniforms: { frameSizeRCP: null, samplePosMult: null, bloomStrength: null, sigma: null }
			},
			bg: {
				handle: null
			}
	...
	ctx.shd.blur = util.compileAndLinkShader(gl, simpleQuad, blurShaderSrc, ["frameSizeRCP", "samplePosMult", "bloomStrength", "sigma"], "#define KERNEL_SIZE " + kernelSize + '\n');
