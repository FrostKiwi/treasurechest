...
#if 0
/* Actually malloc() this array when giving it to Nuklear. Otherwise it will
   go out of scope, when the actual rendering happens in another scope or
   thread*/
nk_rune ranges_japan[] = {
    ...
    /* 0x4E00, 0x9FFF, */	/* CJK Kanji block, without 𠮟, slow to load */
    /* Joyo Kanji List */
